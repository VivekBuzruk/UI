...
@NgModule({
  declarations: [ProductWidgetComponent, ProductConfigFormComponent, ProductDetailComponent, ProductDeleteFormComponent],
  entryComponents: [ProductWidgetComponent, ProductConfigFormComponent, ProductDetailComponent, ProductDeleteFormComponent],
  imports: [
